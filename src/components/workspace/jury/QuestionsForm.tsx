        ...
        {questions.map((question, index) => (
          <div key={index} className="rounded-2xl bg-[#202020] p-6">
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-slate-700 bg-[#181818] px-4 py-3 text-sm text-slate-200 placeholder-slate-500 outline-none transition focus:border-electric focus:ring-2 focus:ring-electric/20"
              rows={4}
            />
          </div>
        ))}
